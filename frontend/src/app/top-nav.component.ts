    ...
    @if (visible()) {
      <nav class="nav nav-top">
        ...
        @if (auth.isAuthenticated()) {
          <a routerLink="/orders" routerLinkActive="is-active" style="display: inline-flex; align-items: center; gap: 5px;">
          ...
          <a routerLink="/my-orders" routerLinkActive="is-active" style="display: inline-flex; align-items: center; gap: 5px;">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
